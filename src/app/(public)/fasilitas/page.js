...
export default function FasilitasAsrama() {
  ...
  return (
    <div className="bg-[#f9f8f6] pb-24 min-h-screen text-left font-lora overflow-x-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 mt-28 mb-20 reveal opacity-0 translate-y-12 transition-all duration-1000 ease-out">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white border border-[#e8e4db] p-8 rounded-sm shadow-[4px_4px_0px_0px_rgba(23,20,18,0.05)] hover:-translate-y-1 hover:shadow-lg transition-all duration-300 flex flex-col">
            <div className="w-12 h-12 bg-amber-50 rounded-full flex items-center justify-center text-amber-600 border border-amber-100 mb-6"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg></div>
            ...
            {panduanUrls.prosedur && panduanUrls.prosedur !== "#" ? (
              <a href={panduanUrls.prosedur} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#171412] hover:bg-amber-600 text-white px-5 py-3 rounded-sm text-xs font-bold uppercase tracking-wide transition-all font-sans"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" x2="12" y1="15" y2="3"></line></svg> Unduh Prosedur</a>
          ...
          <div className="bg-white border border-[#e8e4db] p-8 rounded-sm shadow-[4px_4px_0px_0px_rgba(23,20,18,0.05)] hover:-translate-y-1 hover:shadow-lg transition-all duration-300 flex flex-col">
            <div className="w-12 h-12 bg-red-50 rounded-full flex items-center justify-center text-red-800 border border-red-100 mb-6"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg></div>
            ...
            {panduanUrls.aturan && panduanUrls.aturan !== "#" ? (
              <a href={panduanUrls.aturan} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-red-800 hover:bg-amber-600 text-white px-5 py-3 rounded-sm text-xs font-bold uppercase tracking-wide transition-all font-sans"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" x2="12" y1="15" y2="3"></line></svg> Unduh Aturan</a>
            ) : <span className="inline-block px-5 py-3 bg-stone-100 text-stone-400 text-xs font-bold uppercase tracking-wide text-center rounded-sm cursor-not-allowed font-sans">File Belum Tersedia</span>}
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 mt-20 w-full text-left reveal opacity-0 translate-y-12 transition-all duration-1000 ease-out">
        <div className="flex items-center gap-4 mb-10 border-t border-[#e8e4db] pt-16">
          <div className="w-14 h-14 bg-[#171412] rounded-sm flex items-center justify-center text-white"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg></div>
          <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
            {dataFasilitas.map(item => (
              <div key={item.id} className="bg-white rounded-sm shadow-[4px_4px_0px_0px_rgba(23,20,18,0.05)] border border-[#e8e4db] overflow-hidden group flex flex-col transition-all duration-300 w-full text-left">
                {/* SUNTIKAN SLIDER IMAGE MULTI FOTO */}
