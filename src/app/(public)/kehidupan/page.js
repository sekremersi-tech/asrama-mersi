                  ...
                  <>
                    ...
                    <div className="mt-6 flex flex-wrap items-center gap-3">
                      ...
                      <div className="flex items-center gap-2">
                         ...
                         {/* Instagram */}
                         <button onClick={() => handleShare('instagram')} className="w-8 h-8 rounded-full bg-stone-100 hover:bg-pink-100 text-stone-600 hover:text-pink-600 flex items-center justify-center transition-colors shadow-sm" title="Bagikan ke Instagram Story">
