        ...
        <div className="relative w-full h-[580px] md:h-[450px] mb-8">
          {sejarahPages.map((teks, index) => {
            ...
            return (
              <div 
                key={index} 
                className={`absolute inset-0 bg-[#fdfbf7] p-8 md:p-12 rounded-sm border border-[#e8e4db] shadow-[4px_4px_15px_rgba(0,0,0,0.08)] transition-all duration-700 ease-in-out flex flex-col
