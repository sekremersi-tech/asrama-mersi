...
export default function AdminDashboard() {
  ...
  // -- HELPER: SAFE IMAGE URL EXTRACTOR --
  const getSafeImageUrl = (imgData) => {
    if (!imgData) return "https://placehold.co/600x400/e2e8f0/64748b?text=Tanpa+Gambar";
