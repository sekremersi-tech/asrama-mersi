...
export default function AdminDashboard() {
  ...
  const [judulGaleri, setJudulGaleri] = useState(""); const [deskripsiGaleri, setDeskripsiGaleri] = useState(""); const [warnaGaleri, setWarnaGaleri] = useState("#ffffff"); const [filesGaleri, setFilesGaleri] = useState([]); const [editGaleriId, setEditGaleriId] = useState(null);
