                ...
                <table className="w-full text-left text-sm">
                  <thead>
                    <tr className="bg-slate-50 border-y text-slate-600">
                      ...
                      <th className="p-3">Asal & Suku</th>
                      <th className="p-3">Kampus & Jurusan</th>
                      <th className="p-3 text-center">Aksi</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y">
                    {dataPendaftarAsrama.length === 0 ? <tr><td colSpan="5" className="p-8 text-center text-slate-500">Belum ada calon warga yang mendaftar.</td></tr> : (
                      dataPendaftarAsrama.map(item => (
                        <tr key={item.id}>
                          ...
                          <td className="p-3 text-xs">{item.asal}<br/><span className="font-semibold text-amber-700">{item.suku}</span></td>
                          <td className="p-3 text-xs">{item.kuliah}<br/><span className="text-stone-500">{item.jurusan}</span></td>
