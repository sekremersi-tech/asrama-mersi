...
export default function AdminDashboard() {
  ...
  // DITAMBAHKAN: State khusus untuk Penyewaan
  ...
  // DIKEMBALIKAN KE BENTUK AWAL: Fasilitas Murni
  ...
  // DITAMBAHKAN: Fungsi Khusus Penyewaan
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* TAB 5: FASILITAS UMUM (Tanpa harga sewa) */}
        {activeTab === "fasilitas" && (
                  ...
                  return (
                    <div key={item.id} className="bg-slate-50 border border-slate-200 rounded-lg flex flex-col overflow-hidden">
                      ...
                      <div className="p-4 flex flex-col flex-grow">
                        ...
                        <button onClick={() => handleDelete("daftar_fasilitas", item.id)} className="bg-red-600 text-white text-xs px-3 py-1.5 mt-3 rounded">Hapus</button>
                      </div>
                    </div>
                  );
                })}
        ...
        {/* TAB 6: LAYANAN PENYEWAAN (BARU & DIPISAHKAN) */}
        {activeTab === "penyewaan" && (
          <div className="space-y-6">
              ...
              <form onSubmit={handleSubmitPenyewaan} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" required value={namaSewa} onChange={(e) => setNamaSewa(e.target.value)} placeholder="Cth: Grup Randai / Tari Piring..." className="w-full px-4 py-2 border rounded-md" />
                  </div>
                  <div>
                    <label className="text-sm font-semibold mb-1 block">Kategori Penyewaan</label>
                    <select value={kategoriSewa} onChange={(e) => setKategoriSewa(e.target.value)} className="w-full px-4 py-2 border rounded-md bg-white">
                ...
                <button type="submit" disabled={loading} className="w-full bg-amber-600 hover:bg-amber-700 text-white px-4 py-2 rounded-md font-bold transition-colors">Tambahkan Layanan</button>
              </form>
            </div>
                  ...
                  return (
                    <div key={item.id} className="bg-slate-50 border border-slate-200 rounded-lg flex overflow-hidden">
                      ...
                      <div className="p-4 flex flex-col w-full justify-center">
                        ...
                        <button onClick={() => handleDelete("daftar_penyewaan", item.id)} className="text-red-500 text-xs font-semibold self-start hover:underline">Hapus</button>
                      </div>
                    </div>
                  );
                })}
