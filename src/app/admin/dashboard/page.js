...
export default function AdminDashboard() {
  ...
  // STATE KEPENGURUSAN ASRAMA (BARU)
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex space-x-2 mb-8 bg-white p-2 rounded-xl shadow-sm border border-slate-200 overflow-x-auto">
          ...
          {/* TAB KEPENGURUSAN BARU */}
          <button onClick={() => { setActiveTab("kepengurusan"); setStatus({}); }} className={`px-4 py-2 text-sm rounded-lg font-medium whitespace-nowrap ${activeTab === "kepengurusan" ? "bg-red-50 text-red-800" : "text-slate-700 hover:bg-slate-50"}`}>Struktur Kepengurusan</button>
